...
public class MusicListActivity extends BaseListActivity {
	...
	protected void showProcessDialog() {
		progress_dialog = ProgressDialog.show(this, null, "姝ｅ湪鎵弿");
	}
	...
	protected Dialog onCreateDialog(int id) {
		...
		AlertDialog dialog = CommonAlertDialogBuilder.getInstance(this)
				.setIcon(R.drawable.ic_menu_scan).setTitle("璇烽�夋嫨鎵弿鐩綍")
	...
	private final void addMediaToPlaylist(Set<String> medias) {
		...
		initListAdapter();
		Toast.makeText(this, "新建列表成功", Toast.LENGTH_LONG).show();
	}
	...
	public void initListAdapter() {
		...
		count_audio.setText("鍏�" + String.valueOf(musicList.size()) + "棣�");
	...
	private void showItemLongClickDialog(final long id) {
		...
		final CharSequence[] items = { "閲嶅懡鍚�", "鍒犻櫎" };
