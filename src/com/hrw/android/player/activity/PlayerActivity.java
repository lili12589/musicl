	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		playback_mode_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				intent.putExtra("sms_body","这首歌很棒，我推荐给你，希望你喜欢，名字叫做：" );
		...
		if (belmotPlayer.getPlayerEngine().isPlaying()) {
			...
			myImageView = (ImageView) findViewById(R.id.playback_album_art);  
			myImageView.setImageResource(R.drawable.default_album);
			myAlphaAnimation=AnimationUtils.loadAnimation(this, R.anim.round);  
		...
		//	myAlphaAnimation.setFillAfter(true);
		}
	}
